...
_MIGRATIONS = [
    ...
    "ALTER TABLE my_pr_actions ADD COLUMN their_case TEXT",
    "ALTER TABLE my_pr_actions ADD COLUMN unknowns TEXT",
    "ALTER TABLE handovers ADD COLUMN error TEXT",
    "ALTER TABLE handovers ADD COLUMN started_at TEXT",
